class UserBank < ApplicationRecord
    ...
    validates :phone, presence: true,format: { with: /\0[0-9]/, message: "only allows numbers" }
    validates :second_phone, presence: false,format: { with: /\0[0-9]/, message: "only allows numbers" }
